        ...
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <div className="bg-gray-50 rounded border border-gray-200 p-8 sticky top-24">
              ...
              <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded text-xs text-amber-800 space-y-1.5 leading-relaxed">
                <p className="font-semibold text-amber-900">⚠ Расчёт является предварительным</p>
                <p>Итоговая стоимость определяется только после индивидуальной проработки заказа и может отличаться от расчётной. В зависимости от условий договора, объёма работ и иных факторов применяются скидки или повышающие коэффициенты.</p>
              </div>
            </div>
          </div>
        </div>

        <div className="max-w-5xl mx-auto mt-6 px-1">
          <div className="border border-gray-200 rounded bg-gray-50 p-4 text-xs text-gray-500 leading-relaxed">
            <span className="font-semibold text-gray-600">Важно.</span> Расчёт носит справочный (ориентировочный) характер и не является офертой или гарантией итоговой стоимости. Финальная цена согласовывается с заказчиком на основании акта диагностики до начала выполнения работ. К расчёту могут применяться понижающие коэффициенты (скидки за объём, долгосрочное сотрудничество, плановые работы) или повышающие коэффициенты (экстренность, сложность доступа к узлам, работа в выходные и праздничные дни, удалённость объекта). Стоимость запчастей и расходных материалов рассчитывается отдельно и включается в коммерческое предложение.
          </div>
        </div>
      </div>
    </section>
