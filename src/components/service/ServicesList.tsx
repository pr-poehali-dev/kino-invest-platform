  ...
  const services = [
    {
      ...
      description: 'Аварийные поломки, восстановление работоспособности станков любой сложности. Выезд инженера от 2 часов* при наличии специалиста в вашем регионе.',
