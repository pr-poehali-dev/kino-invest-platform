  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="🎯 Проектируем цех с нуля → Подбираем станки → Запускаем за 6-12 месяцев. ✅ Технический аудит бесплатно ✅ 3D-моделирование ✅ ROI расчёт ✅ Собственное КБ ✅ Гарантия запуска. 1200+ цехов работают. Получите расчёт → +7 (343) 287-08-08"
