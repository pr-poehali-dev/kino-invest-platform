  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO 
        ...
        description="🏢 С 1990 года помогаем предприятиям РФ. ✅ Собственный завод УЗИС ✅ КБ из 40 инженеров ✅ Представительства во всех промрегионах ✅ Партнёры мировых брендов ✅ 1200+ запущенных производств. Стать клиентом → +7 (343) 287-08-08"
