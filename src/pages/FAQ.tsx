  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        ...
        description="Ответы на популярные вопросы о инжиниринге, поставке инструмента, ремонте станков, механообработке. ✅ Сроки ✅ Гарантии ✅ Цены ✅ Условия работы. Не нашли ответ? → Звоните: +7 (343) 287-08-08"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-[#A8B2C0]">
              Ответы на популярные вопросы о наших услугах. Не нашли ответ? Звоните: <a href="tel:+73432870808" className="text-[#CD7F32] hover:underline font-bold">+7 (343) 287-08-08</a>
            </p>
          </div>
        </div>
      </section>
