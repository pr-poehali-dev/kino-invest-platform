  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="🔧 Собственное производство УЗИС → Фрезы, резцы, оснастка. ✅ В наличии 3000+ позиций ✅ Отгрузка день-в-день ✅ Доставка по РФ ✅ Техподдержка 24/7 ✅ Цены от производителя. Нужен инструмент срочно? → Звоните: +7 (343) 287-30-58"
